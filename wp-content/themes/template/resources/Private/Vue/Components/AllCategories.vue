        ...
        <table class="table-border-properties table table-warning">
            ...
            <tr class="row m-0">
                <th class="d-inline-block col-12">
                    <input type="text" id="table-search-form" class="search form-control" placeholder="Hľadajte názov kategórie" v-model="filter_name">
                </th>
            </tr>
            <tr class="row m-0 text-primary table-header-bottom-border">
                <td class="d-inline-block col-sm-12 col-md-2">#</td>
                <td class="d-inline-block col-sm-12 col-lg-8 col-md-6">Kategória</td>
